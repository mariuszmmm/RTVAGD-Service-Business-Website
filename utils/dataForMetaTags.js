...
export const dataForMetaTags = {
  home: {
    metaTags: {
      ...
      ogImage: `${urls.home}share.png`,
      ogImageWidth: "931",
      ogImageHeight: "497",
      ogImageAlt: shortName,
  ...
  naprawa_pralek: {
    metaTags: {
      ...
      ogSiteName: `${shortName} - naprawa pralek`,
      ogImage: "https://res.cloudinary.com/difc0i71u/image/upload/v1731168333/Serwis/naprawa-pralki.webp",
      ogImageWidth: "599",
      ogImageHeight: "729",
      ogImageAlt: "naprawa pralek",
  ...
  naprawa_suszarek: {
    metaTags: {
      ...
      ogSiteName: `${shortName} - naprawa suszarek`,
      ogImage: "https://res.cloudinary.com/difc0i71u/image/upload/v1733118542/Serwis/naprawa-suszarki.webp",
      ogImageWidth: "700",
      ogImageHeight: "865",
      ogImageAlt: "naprawa suszarek",
      ogImageType: "image/webp",
  ...
  naprawa_zmywarek: {
    metaTags: {
      ...
      ogSiteName: `${shortName} - naprawa zmywarek`,
      ogImage: "https://res.cloudinary.com/difc0i71u/image/upload/v1731168333/Serwis/serwis-zmywarek.webp",
      ogImageWidth: "538",
      ogImageHeight: "706",
      ogImageAlt: "naprawa zmywarek",
      ogImageType: "image/webp",
  ...
  naprawa_ekspresow: {
    metaTags: {
      ...
      ogSiteName: `${shortName} - naprawa ekspresów`,
      ogImage: "https://res.cloudinary.com/difc0i71u/image/upload/v1731168333/Serwis/naprawa-ekspresow.webp",
      ogImageWidth: "700",
      ogImageHeight: "700",
      ogImageAlt: "naprawa ekspresów",
      ogImageType: "image/webp",
  ...
  naprawa_telewizorow: {
    metaTags: {
      ...
      ogSiteName: `${shortName} - naprawa telewizorów`,
      ogImage: "https://res.cloudinary.com/difc0i71u/image/upload/v1731168332/Serwis/serwis-telewizorow.webp",
      ogImageWidth: "918",
      ogImageHeight: "743",
      ogImageAlt: "naprawa telewizorów",
      ogImageType: "image/webp",
